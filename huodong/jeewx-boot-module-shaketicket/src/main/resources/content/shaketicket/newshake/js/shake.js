...
var box_dialog = function(opt){
	...
	$('<div class="foot"><a class="btn -share" onclick="show(\'fx\')">分享</a><a class="btn -gifts lr">点击领取</a></div>').appendTo(dlg);
	return box;
};
var box_dialog2 = function(opt){
	...
	var cont = $('<div class="content"></div>').appendTo(dlg);
	cont.html(opt.content);
	$('<div class="foot"><a class="btn -share" onclick="show(\'fx\')">分享</a><a class="btn -gifts lr">关闭</a></div>').appendTo(dlg);
	return box;
};
// shake.event
