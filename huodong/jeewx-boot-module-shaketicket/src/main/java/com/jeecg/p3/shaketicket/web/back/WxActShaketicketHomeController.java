...
public void toAddDialog(HttpServletRequest request,HttpServletResponse response,ModelMap model)throws Exception{
	 ...
	 velocityContext.put("awards",awards);
	 //update-begin--Author:zhangweijian  Date: 20180913 for：传入jwid
...
public void toEdit(@RequestParam(required = true, value = "id" ) String id,HttpServletResponse response,HttpServletRequest request) throws Exception{
		 ...
		 velocityContext.put("awards",awards);
		 List<WxActShaketicketConfig> awarsDetailList=wxActShaketicketConfigService.queryByActId(id);
		//update-begin-zhangweijian-----Date:20180830----for:将小数转为整数
		 //将小数转为整数
		 for(WxActShaketicketConfig list:awarsDetailList){
		...
		//update-end-zhangweijian-----Date:20180830----for:将小数转为整数
		 velocityContext.put("awarsDetailList",awarsDetailList);
		//update-begin--Author:zhangweijian  Date: 20180913 for：传入jwid
		 velocityContext.put("jwid",jwid);
		//update-end--Author:zhangweijian  Date: 20180913 for：传入jwid
		...
		//查询参与人数
		 int count=wxActShaketicketRecordService.getCountByActId(id);
